...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <a href="/golongan/create" class="btn btn-secondary mb-2">Tambah Golongan</a>
    ...
    <?php $__currentLoopData = $golongan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $g): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><a href="/golongan/<?php echo e($g->id); ?>/edit" class="btn btn-secondary mb-2" style="width:70px !important;">Edit</a> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\xampp\htdocs\quis-laravel\quis-laravel\resources\views/golongan/index.blade.php ENDPATH**/ ?>